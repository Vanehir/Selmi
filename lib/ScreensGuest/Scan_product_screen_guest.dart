...
class ScanProductScreenGuest extends StatefulWidget {
  final String nome;
  final String immagine;
  const ScanProductScreenGuest({required this.nome, required this.immagine,super.key});

  @override
  State<ScanProductScreenGuest> createState() => _ScanProductScreenGuestState();
}

class _ScanProductScreenGuestState extends State<ScanProductScreenGuest> {
  bool isStar = false;
