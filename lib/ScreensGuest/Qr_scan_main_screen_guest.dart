  ...
  Future<void> scanBarcode() async {
    ...
    try {
      ...
      if (risultato == "Selmi One Temperatrice Cioccolato") {
        ...
        immagine =
            "https://www.selmi-group.it/img/macchine-temperaggio-cioccolato/color-ex-temperatrice-cioccolato/color-ex-temperatrice-cioccolato.png";
      } else if (risultato == "Plus EX Temperatrice Cioccolato") {
        immagine =
            "https://www.selmi-group.it/img/macchine-temperaggio-cioccolato/plus-ex-temperatrice-cioccolato/plus-ex-temperatrice-cioccolato.png";
      } else if (risultato == "Plus EX Temperatrice Cioccolato") {
        immagine =
            "https://www.selmi-group.it/img/macchine-temperaggio-cioccolato/plus-ex-temperatrice-cioccolato/plus-ex-temperatrice-cioccolato.png";
      } else if (risultato == "Top Ex Temperatrice Cioccolato") {
        immagine =
            "https://www.selmi-group.it/img/macchine-temperaggio-cioccolato/top-ex-temperatrice-cioccolato/top-ex-temperatrice-cioccolato.png";
      } else if (risultato == "Cento Temperatrice Cioccolato") {
        immagine =
            "https://www.selmi-group.it/img/macchine-temperaggio-cioccolato/cento-temperatrice-cioccolato/cento-temperatrice-cioccolato.png";
      }
