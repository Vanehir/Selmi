...
class _MyHomePageState extends State<MyHomePage> {
  final TextEditingController _passwordInput =
      TextEditingController(); // recupera l'imput della password dal TextField
  final TextEditingController _usernameInput =
      TextEditingController(); // recupera l'imput della username dal textField
  ...
  void _checkInput() {
    if (_usernameInput.text == vaule && _passwordInput.text == vaule) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        // sposta tutti i child che ha al suo interno per fare spazio alla tastiera al momento dell'uso
        child: Center(
          child: Column(
            ...
            children: <Widget>[
              ...
              const Text(
                'Selmi',
                style: TextStyle(
                    color: primario, fontWeight: FontWeight.bold, fontSize: 50),
              ), // Selmi
              SizedBox(
              ...
              Container(
                ...
                child: TextField(
                  ...
                  style:
                      const TextStyle(color: Color(0xFF25344D), fontSize: 23),
              ...
              TextButton(
                  ...
                  child: const Text(
                    "Forgot Password?",
                    style: TextStyle(color: secondario, fontSize: 17),
                  )), // forgot password
              TextButton(
                  onPressed: _register,
                  child: const Text(
      ...
      backgroundColor:
          background, // This trailing comma makes auto-formatting nicer for build methods.
    );
  }
}
